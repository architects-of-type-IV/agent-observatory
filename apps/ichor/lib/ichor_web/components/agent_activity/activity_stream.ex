defmodule IchorWeb.Components.AgentActivity.ActivityStream do
  @moduledoc """
  Renders a scrollable stream of agent activity events.
  """

  use Phoenix.Component
  import IchorWeb.Components.AgentActivity.ActivityItem
  ...
  def activity_stream(assigns) do
    ~H"""
    <div class="space-y-1">
      <div :if={@events == []} class="text-xs text-low p-2">
        No activity yet
      </div>
