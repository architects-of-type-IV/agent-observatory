defmodule IchorWeb.DashboardLive do
  ...
  @tmux_events ~w(connect_tmux disconnect_tmux disconnect_tmux_tab close_all_tmux switch_tmux_tab toggle_tmux_layout send_tmux_keys kill_tmux_session kill_sidebar_tmux launch_session toggle_terminal_panel close_terminal_panel cycle_panel_position cycle_panel_size terminal_panel_init terminal_panel_resize toggle_session_picker)
