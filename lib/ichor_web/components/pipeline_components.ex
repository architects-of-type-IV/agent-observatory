defmodule IchorWeb.Components.PipelineComponents do
  ...
  defp task_border("completed", true, _), do: "border-success/60 ring-1 ring-success/20"
  defp task_border("completed", _, true), do: "border-interactive/60"
  defp task_border("completed", _, _), do: "border-success/30"
  defp task_border("in_progress", true, _), do: "border-info/60 ring-1 ring-info/20"
  defp task_border("in_progress", _, true), do: "border-interactive/60"
  defp task_border("in_progress", _, _), do: "border-info/40"
  defp task_border("failed", _, _), do: "border-error/40"
  defp task_border(_, _, true), do: "border-interactive/60"
  defp task_border(_, true, _), do: "border-border-subtle ring-1 ring-low/20"
  defp task_border(_, _, _), do: "border-border"

  defp task_bg("completed"), do: "bg-success/5"
  defp task_bg("in_progress"), do: "bg-info/5"
  defp task_bg("failed"), do: "bg-error/5"
  defp task_bg(_), do: "bg-base/50"

  defp task_dot("completed"), do: "bg-success"
  defp task_dot("in_progress"), do: "bg-info animate-pulse"
  defp task_dot("failed"), do: "bg-error"
  defp task_dot("pending"), do: "bg-low"
  defp task_dot(_), do: "bg-highlight"
