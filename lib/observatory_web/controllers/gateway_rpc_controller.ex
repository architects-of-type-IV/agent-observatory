defmodule ObservatoryWeb.GatewayRpcController do
  @moduledoc """
  ...
  def create(conn, %{"channel" => channel, "payload" => payload}) when is_binary(channel) and is_map(payload) do
    case Observatory.Gateway.Router.broadcast(channel, payload) do
      {:ok, delivered} ->
        conn
        |> put_status(:ok)
