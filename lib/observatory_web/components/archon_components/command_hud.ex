defmodule ObservatoryWeb.Components.ArchonComponents.CommandHud do
  @moduledoc false

  use Phoenix.Component

  import ObservatoryWeb.Components.ArchonComponents.Icons, only: [hud_icon: 1]
  ...
  defp output_entry(%{msg: %{type: :msg_sent, data: d}} = assigns) do
    ...
    <div class="archon-output-section">
      ...
      <div class={"archon-output-card #{if @result["status"] == "sent", do: "archon-output-card-success", else: "archon-output-card-error"}"}>
        ...
        <div :if={@result["error"]} class="archon-output-card-detail" style="color: hsl(var(--noir-red))">{@result["error"]}</div>
      </div>
    </div>
    """
  end
  ...
  defp output_entry(%{msg: %{type: :error, data: data}} = assigns) do
    ...
    ~H"""
    <div class="archon-output-section">
      <div class="archon-output-entry" style="color: hsl(var(--noir-red))">
