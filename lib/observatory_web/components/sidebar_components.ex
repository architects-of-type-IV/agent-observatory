defmodule ObservatoryWeb.Components.SidebarComponents do
  @moduledoc """
  ...
  import ObservatoryWeb.DashboardFormatHelpers, only: [session_duration: 2, short_session: 1, session_color: 1]
  ...
  defp session_item(assigns) do
    ...
    >
      <div class="flex items-center gap-1.5">
        ...
        <ObservatoryWeb.ObservatoryComponents.model_badge model={@session.model} />
      </div>
