defmodule ObservatoryWeb.Components.ArchonComponents do
  ...
  import ObservatoryWeb.Components.ArchonComponents.Icons, only: [archon_icon: 1]
  import ObservatoryWeb.Components.ArchonComponents.CommandHud, only: [command_hud: 1]
  import ObservatoryWeb.Components.ArchonComponents.ChatPanel, only: [chat_panel: 1]
  import ObservatoryWeb.Components.ArchonComponents.ReferencePanel, only: [reference_panel: 1]
