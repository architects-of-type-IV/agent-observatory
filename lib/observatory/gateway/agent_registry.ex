defmodule Observatory.Gateway.AgentRegistry do
  ...
  alias Observatory.Gateway.AgentRegistry.{AgentEntry, EventHandler, IdentityMerge, Sweep, TeamSync}
  ...
  def broadcast_update do
    Phoenix.PubSub.broadcast(Observatory.PubSub, "gateway:registry", :registry_changed)
  end
