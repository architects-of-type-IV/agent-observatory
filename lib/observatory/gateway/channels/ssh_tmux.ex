defmodule Observatory.Gateway.Channels.SshTmux do
  @moduledoc """
  ...
  Configuration:
      ...
      config :observatory, Observatory.Gateway.Channels.SshTmux,
        connect_timeout: 5,
  ...
  defp ssh_tmux(host, tmux_args) do
    config = Application.get_env(:observatory, __MODULE__, [])
