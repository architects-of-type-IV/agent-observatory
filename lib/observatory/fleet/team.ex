  ...
  actions do
    ...
    action :create_team, :map do
      ...
      run fn input, _context ->
        ...
        case Observatory.Fleet.FleetSupervisor.create_team(opts) do
          {:ok, pid} ->
    ...
    action :disband, :map do
      ...
      run fn input, _context ->
        case Observatory.Fleet.FleetSupervisor.disband_team(input.arguments.name) do
    ...
    action :spawn_member, :map do
      ...
      run fn input, _context ->
        ...
        case Observatory.Fleet.TeamSupervisor.spawn_member(args.team_name, opts) do
          {:ok, pid} ->
