defmodule Observatory.Workshop.TeamBlueprint do
  @moduledoc """
  ...
  relationships do
    has_many :agent_blueprints, Observatory.Workshop.AgentBlueprint
    has_many :spawn_links, Observatory.Workshop.SpawnLink
    has_many :comm_rules, Observatory.Workshop.CommRule
  end
