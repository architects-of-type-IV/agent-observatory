defmodule Ichor.Projects.Run do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :source, Ichor.Projects.Types.RunSource do
      allow_nil?(false)
      public?(true)
    ...
    attribute :status, Ichor.Projects.Types.RunStatus do
      allow_nil?(false)
      default(:active)
      public?(true)
    end
  ...
  relationships do
    has_many :jobs, Ichor.Projects.Job
  end
