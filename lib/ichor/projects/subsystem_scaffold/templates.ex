defmodule Ichor.Projects.SubsystemScaffold.Templates do
  @moduledoc """
  ...
  def integration(app_name, module_name) do
    ...
    ```elixir
    {:ok, project} = Ichor.Projects.get_project(project_id)
    Ichor.Projects.SubsystemLoader.compile_and_load(project)
    ```
