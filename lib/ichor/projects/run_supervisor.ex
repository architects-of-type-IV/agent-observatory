defmodule Ichor.Projects.RunSupervisor do
  @moduledoc """
  DynamicSupervisor facade for Dag.RunProcess children.

  The underlying DynamicSupervisor is named `Ichor.Projects.DynRunSupervisor`
  and is started by `Ichor.Projects.ExecutionSupervisor`.
  """

  alias Ichor.Projects.RunProcess

  @supervisor Ichor.Projects.DynRunSupervisor
