defmodule Ichor.Control.AgentProcess.Mailbox do
  @moduledoc """
  Mailbox routing and delivery helpers for agent processes.
  """

  alias Ichor.Control.AgentProcess.Delivery

  @max_message_buffer 200

  @doc "Normalize, buffer, broadcast, and route an incoming message. Returns updated state."
  @spec apply_incoming_message(Ichor.Control.AgentProcess.t(), map() | String.t()) ::
          Ichor.Control.AgentProcess.t()
  ...
  @spec deliver_unread(Ichor.Control.AgentProcess.t()) :: Ichor.Control.AgentProcess.t()
  ...
  @doc false
  @spec route_message(map(), Ichor.Control.AgentProcess.t()) :: Ichor.Control.AgentProcess.t()
