defmodule Ichor.Control.TeamBlueprint do
  @moduledoc """
  ...
  relationships do
    has_many :agent_blueprints, Ichor.Control.AgentBlueprint
    has_many :spawn_links, Ichor.Control.SpawnLink
    has_many :comm_rules, Ichor.Control.CommRule
  end
