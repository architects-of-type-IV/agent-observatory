defmodule Ichor.Factory.Node do
  @moduledoc """
  ...
  relationships do
    belongs_to :mes_project, Ichor.Factory.Project do
      attribute_public?(true)
      allow_nil?(true)
    end

    has_many :artifacts, Ichor.Factory.Artifact
    has_many :roadmap_items, Ichor.Factory.RoadmapItem
  end
