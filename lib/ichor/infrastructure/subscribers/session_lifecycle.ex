defmodule Ichor.Infrastructure.Subscribers.SessionLifecycle do
  @moduledoc """
  Infrastructure subscriber for session and team lifecycle signals.

  Reacts to signals emitted by the Signals domain (EventStream / AgentLifecycle)
  and performs the corresponding Infrastructure-side mutations:
  ...
  This is the only place in the Infrastructure domain that owns the reaction
  to Signals-originated lifecycle events. No Infrastructure module calls back
  into Signals.
  """
